export default function SkillsSection() {
	const skills = ['JavaScript', 'Python', 'React', 'Node.js', 'HTML5', 'CSS3', 'ExpressJS', 'React/Redux', 'Flask', 'PANDAS', 'SQL', 'PostgreSQL', 'MySQL', 'SQLAlchemy', 'SQLite3', 'AWS S3', 'Selenium', 'BS4'];
